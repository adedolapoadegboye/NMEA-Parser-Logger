...
class GNSSTestTool:
    ...
    def create_widgets(self):
        ...
        self.results_notebook.add(self.accuracy_tab, text="Test Stats")
    ...
    def show_static_file_mode(self):
        ...
        # Clear Button
        ttk.Button(file_frame, text="Clear", command=self.start_file_mode).grid(row=4, column=3, columnspan=3, pady=15)
    ...
    def clear_accuracy_plot(self):
        ...
        Clears the figure, reinitializes the axes, and resets device plot data.
        """
